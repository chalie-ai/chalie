...
def run_preflight() -> dict[str, dict[str, object]]:
    ...
    # broken". onnxruntime failing to import at all is a terminal error; a
    # present but not-yet-built session is still warming up.
    try:
        ...
        components['embeddings'] = {
            'status': 'error',
            'message': 'The embedding runtime is unavailable. Reinstall Chalie to restore it.',
        }
