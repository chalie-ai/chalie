...
from typing import TYPE_CHECKING, List, Dict, Optional, cast
...
def append(
    ...
    try:
        ...
        _maybe_trigger_extraction(channel, cast(int, rowid))
        ...
        try:
            ...
            for ep in snapshots:
                try:
                    ...
                    raw_ids = cast(list[int], ep.get('transcript_ids') or [])
...
def _safe_json_load(text: str) -> list[dict[str, object]]:
    import json as _json
