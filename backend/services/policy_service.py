...
_CHAT_ALLOW: dict[str, State] = {
    ...
    "git.get_repo": "allow", "git.list_branches": "allow",
    "git.list_commits": "allow", "git.get_commit": "allow",
    "git.list_prs": "allow", "git.get_pr": "allow",
    "git.list_issues": "allow", "git.get_issue": "allow",
    "git.list_releases": "allow", "git.search_repos": "allow",
    "git.read_file": "allow", "git.clone": "allow", "git.diff": "allow",
