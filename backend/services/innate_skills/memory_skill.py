...
TOOL_SCHEMA = {
    ...
    "description": (
        ...
        "RECALL RULES — trigger recall when the user says things like:\n"
        "- 'What do I know about X' / 'What do you know about me'\n"
        "- 'Remind me — what was that thing about X' / 'what was that X I mentioned'\n"
        "- 'Didn't I tell you about X' / 'I told you about X before'\n"
        "- 'What did I say about X'\n"
        "- Any question probing their own traits, preferences, habits, or relationships\n"
        "DISAMBIGUATION: 'Remind me to [future action] [at time]' → use the "
        "scheduler tool, NOT memory. "
        "'Remind me [of something I already said/told you]' → use memory recall.\n\n"
