...
def image_server() -> Generator[tuple[str, type[_ImageHandler]], None, None]:
...
def _reset_handler() -> Generator[None, None, None]:
...
class TestBuildImageCandidates:
    ...
    def test_dedup_by_url_in_input_order(self, image_server: tuple[str, type[_ImageHandler]]) -> None:
        from services.image_candidate_service import build_image_candidates
    ...
    def test_caps_at_top_n(self, image_server: tuple[str, type[_ImageHandler]]) -> None:
        from services.image_candidate_service import build_image_candidates
        base, handler = image_server
        urls = []
        for i in range(5):
    ...
    def test_failed_fetch_drops_silently(self, image_server: tuple[str, type[_ImageHandler]]) -> None:
        from services.image_candidate_service import build_image_candidates
        base, handler = image_server
    ...
    def test_tuple_input_carries_source_title(self, image_server: tuple[str, type[_ImageHandler]]) -> None:
        from services.image_candidate_service import build_image_candidates
        base, handler = image_server
    ...
    def test_caption_field_present_in_output(self, image_server: tuple[str, type[_ImageHandler]]) -> None:
        from services.image_candidate_service import build_image_candidates
        base, handler = image_server
...
class TestCaptionFromFilename:
    def test_caption_from_wikipedia_thumbnail_url(self) -> None:
    ...
    def test_caption_empty_when_filename_is_hash(self) -> None:
        from services.image_candidate_service import _caption_from_filename
...
class TestCaptionUsesOgDescription:
    def test_caption_uses_og_description_when_available(self, image_server: tuple[str, type[_ImageHandler]]) -> None:
        from services.image_candidate_service import build_image_candidates
        base, handler = image_server
    ...
    def test_og_description_ignored_when_shorter_than_20_chars(self, image_server: tuple[str, type[_ImageHandler]]) -> None:
        from services.image_candidate_service import build_image_candidates
        base, handler = image_server
