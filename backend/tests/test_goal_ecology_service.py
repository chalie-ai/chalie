...
class TestMotiveAlignment:
    ...
    def test_motive_alignment_increases_salience(self, mock_bridge, mock_embed):
        ...
        # Create two goals — bridge mocked to not overwrite parent_motives
        ...
        # Force recalculate at the same instant
        ecology.recalculate_salience(g_with_motives['id'])
        ecology.recalculate_salience(g_without_motives['id'])
