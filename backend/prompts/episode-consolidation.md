...
- Merges all entities, open_loops, and goal_tags from the sources
...
```json
{
  "intent": {
    ...
    "direction": "string — brief phrase describing the overarching goal across all source episodes"
  },
  ...
  "goal_tags": ["merged list of all goal tags from all source episodes"],
...
**entities** and **goal_tags** — union of all sources, deduplicated.
