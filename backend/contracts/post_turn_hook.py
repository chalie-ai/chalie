...
"""PostTurnHook — the after-turn contract every hook satisfies.
...
hook must satisfy, it stores no data and provides no implementation. Concrete
hooks conform structurally — no inheritance required — mirroring
