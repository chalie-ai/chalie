...
class SkillsListResource(Resource):
    ...
    def get(self) -> ResponseReturnValue:
        ...
        try:
            ...
            return {"skills": skills, "associations": associations}, 200
        except Exception as exc:
    ...
    def post(self) -> ResponseReturnValue:
        ...
        if not use_for:
            return {"error": "use_for is required"}, 400
        if not content:
        ...
        try:
            ...
            try:
                ...
                if existing is not None:
                    return {"error": f"A user skill named '{title}' already exists"}, 409
    ...
    def put(self, skill_id: int) -> ResponseReturnValue:
        ...
        try:
            ...
            try:
                ...
                if row["source"] != "user":
                    return {"error": "Only user-created skills can be edited"}, 403
        ...
        try:
            ...
            try:
                ...
                if row is None:
                    return {"error": "Skill not found"}, 404
                if row["source"] != "user":
                    return {"error": "Only user-created skills can be deleted"}, 403
...
class SkillToggleResource(Resource):
    ...
    def put(self, skill_id: int) -> ResponseReturnValue:
        ...
        try:
            ...
            return {"skill_id": skill_id, "enabled": bool(new_enabled)}, 200
        except Exception as exc:
        ...
        try:
            ...
            try:
                ...
                if row["source"] != "curated":
                    return {"error": "Only curated skills can be copied"}, 400
