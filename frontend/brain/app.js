...
const _POLICY_ACTION_LABELS = {
    ...
    'home_assistant.list_devices': 'List devices', 'home_assistant.get_state': 'Get device state', 'home_assistant.control': 'Control device', 'home_assistant.list_automations': 'List automations', 'home_assistant.trigger_automation': 'Trigger automation',
    'document.search': 'Search documents', 'document.list': 'List documents', 'document.view': 'View document', 'document.create': 'Create document', 'document.delete': 'Delete document', 'document.restore': 'Restore document', 'document.upload': 'Upload file to document library',
...
const _POLICY_CATEGORIES = {
    ...
    'Home Assistant': ['home_assistant.list_devices', 'home_assistant.get_state', 'home_assistant.control', 'home_assistant.list_automations', 'home_assistant.trigger_automation'],
    'Documents': ['document.search', 'document.list', 'document.view', 'document.create', 'document.delete', 'document.restore', 'document.upload'],
